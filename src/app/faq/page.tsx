  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="mx-auto max-w-3xl w-full px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl font-black text-white mb-2 flex items-center gap-3"><HelpCircle className="h-7 w-7 text-violet-400" /> Frequently Asked Questions</h1>
        <p className="text-zinc-500 mb-8">Everything about ordering — no account needed.</p>

        <div className="space-y-4">
          <Card>
            <CardContent className="p-6">
              <h3 className="font-semibold text-white mb-2 flex items-center gap-2"><MessageCircle className="h-4 w-4 text-violet-400" /> How do I buy a product?</h3>
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="font-semibold text-white mb-2 flex items-center gap-2"><ShieldCheck className="h-4 w-4 text-violet-400" /> Is it safe to order this way?</h3>
        ...
        {contacts.length > 0 && (
          <div className="mt-10 rounded-3xl border border-violet-600/30 bg-violet-950/20 p-6">
            <h2 className="font-semibold text-white mb-3 flex items-center gap-2"><Send className="h-4 w-4 text-violet-400" /> Reach us directly</h2>
