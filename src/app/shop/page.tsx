          ...
          <aside className="lg:w-64 shrink-0 space-y-6">
            <div className="rounded-2xl border border-white/5 bg-[#111] p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/shop" className={`block py-1 ${!category?'text-[#22d3ee]':'text-zinc-400 hover:text-white'}`}>All Products</Link></li>
                {categories.map(c=>(
            ...
            <div className="rounded-2xl border border-white/5 bg-[#111] p-4">
              ...
              <div className="flex flex-col gap-2 text-sm">
                <Link href="/shop" className={`py-1 ${!sort?'text-[#22d3ee]':'text-zinc-400'}`}>Featured</Link>
                <Link href="/shop?sort=price_asc" className={`py-1 ${sort==='price_asc'?'text-[#22d3ee]':'text-zinc-400'}`}>Price: Low to High</Link>
                <Link href="/shop?sort=price_desc" className={`py-1 ${sort==='price_desc'?'text-[#22d3ee]':'text-zinc-400'}`}>Price: High to Low</Link>
                <Link href="/shop?sort=newest" className={`py-1 ${sort==='newest'?'text-[#22d3ee]':'text-zinc-400'}`}>Newest</Link>
              </div>
            </div>
          </aside>
