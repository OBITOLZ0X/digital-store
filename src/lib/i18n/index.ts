...
// Admin-controlled strings (store name, hero text, section titles) are NOT here —
...
const en: Dict = {
  ...
  'buy.howToSingle': 'Message us on any channel below — tell us the product and we’ll confirm your order in the chat.',
